...
RUN wget --no-check-certificate "https://github.com/ianfab/Fairy-Stockfish/releases/download/fairy_sf_14_0_1_xq/fairy-stockfish-largeboard_x86-64-modern" -O fairy.zip
...
RUN 7z e fairy.zip && rm fairy.zip && mv fairy stockfish* fairy
